...
class ClaimIngestionHandler:
    ...
    def trigger_workflow(self, claim_id: str, s3_key: str) -> str:
        ...
        if 'dummy-arn' in STATE_MACHINE_ARN:
             logger.warning("Step Functions ARN is not configured. Skipping workflow trigger.")
             return "skipped-workflow-trigger"
